  ...
  return (
    <div className="flex flex-col items-center gap-5 w-full max-w-lg mx-auto">
      ...
      <div className="w-full bg-purple-600 text-white rounded-2xl px-5 py-4 text-center">
        <p className="text-xs text-purple-200 uppercase tracking-wide mb-1">Perfekt — Partizip II</p>
        <p className="text-3xl font-bold">{question.infinitiv}</p>
        {question.translation && (
          <p className="text-purple-200 text-sm mt-1">({question.translation})</p>
        )}
      </div>

      <p className="text-sm text-gray-500 self-start">
        📝 Upiši Partizip II ovog glagola:
      </p>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 w-full text-center">
        ...
        <p className="text-gray-400 text-xs mt-3">haben/sein + <strong>Partizip II</strong></p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="w-full flex gap-2">
        <input ref={inputRef} type="text" value={input}
          ...
          placeholder="Partizip II..." autoCorrect="off" autoCapitalize="none" spellCheck={false} />
